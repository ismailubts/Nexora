...
const DocStoreInputHandler = ({ inputParam, data, disabled = false, onNodeDataChange }) => {
    ...
    const getCredential = () => {
        const credential = data.inputs.credential || data.inputs[NEXORA_CREDENTIAL_ID]
        if (credential) {
            return { credential }
        }
        return {}
                        ...
                        {inputParam.type === 'credential' && (
                            <CredentialInputHandler
                                ...
                                onSelect={(newValue) => {
                                    ...
                                    data.inputs[NEXORA_CREDENTIAL_ID] = newValue // in case data.credential is not updated
                                    if (nodeDataChangeHandler) {
                                        nodeDataChangeHandler({ nodeId: data.id, inputParam, newValue })
                                    }
                                }}

...
import { baseURL, NEXORA_CREDENTIAL_ID } from '@/store/constant'
    ...
    const handleChatModelDataChange = ({ inputParam, newValue }) => {
        setSelectedChatModel((prevData) => {
            ...
            if (inputParam.type === 'credential') {
                ...
                updatedData.inputs = { ...updatedData.inputs, [NEXORA_CREDENTIAL_ID]: newValue }
            } else {
        ...
        for (const inputParam of inputParams) {
            if (!inputParam.optional) {
                if (inputParam.type === 'credential') {
                    ...
                    const credential = selectedChatModel.credential || selectedChatModel.inputs?.[NEXORA_CREDENTIAL_ID]
                    if (!credential) {

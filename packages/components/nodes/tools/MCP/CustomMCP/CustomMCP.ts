        ...
        this.inputs = [
            {
                ...
                warning:
                    process.env.CUSTOM_MCP_PROTOCOL === 'sse'
                        ? 'Only Remote MCP with url is supported. Read more <a href="https://github.com/ismailubts/Nexora/tutorials/tools-and-mcp#streamable-http-recommended" target="_blank">here</a>'
                        : undefined
            },
            {

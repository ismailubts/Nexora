...
import { NEXORAMemory, ICommonObject, IMessage, INode, INodeData, INodeParams, MemoryMethods, MessageType } from '../../../src/Interface'
    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://github.com/ismailubts/Nexora/memory/long-term-memory#ui-and-embedded-chat">more</a>',
                default: '',
...
const initializeMongoDB = async (nodeData: INodeData, options: ICommonObject): Promise<BufferMemory> => {
    ...
    const driverInfo = { name: 'Nexora', version: (await getVersion()).version }

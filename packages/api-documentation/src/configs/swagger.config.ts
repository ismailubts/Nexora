...
const swaggerUiOptions = {
    ...
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from Nexora express backend, based on a swagger.yml file. Swagger is available on: http://localhost:6655/api-docs',
            license: {
                name: 'Proprietary',
                url: 'https://github.com/ismailubts/Nexora/blob/main/LICENSE.md'
            },
            contact: {
                name: 'Abdul Ismail',
                email: 'ismailubts@users.noreply.github.com'
            }
        },
        servers: [
            {
